@enrol @enrol_bank
Feature: Users can auto-enrol thembank in courses where bank enrolment is allowed
  ...
  @javascript
  Scenario: bank-enrolment enabled as guest
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add "bank enrolment" enrolment method with:
  ...
  Scenario: bank-enrolment enabled
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "bank enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
    And I log out
  ...
  Scenario: bank-enrolment enabled requiring an enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "bank enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  Scenario: bank-enrolment disabled
    Given I log in as "student1"
    When I am on "Course 1" course homepage
    Then I should see "You can not enrol yourbank in this course"

  Scenario: bank-enrolment enabled requiring a group enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "bank enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Edit a bank-enrolled user's enrolment from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "bank enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Unenrol a bank-enrolled student from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "bank enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
